...
const AllBooking = () => {
    ...
    useEffect(() => {
        const url = 'https://bongo-car-bazar.herokuapp.com/all-bookings';
        fetch(url)
            .then(res => res.json())
    ...
    if (proceed) {
        const url = `https://bongo-car-bazar.herokuapp.com/approve-booking/${id}`;
        fetch(url, {
            method: 'PUT'
        })
            .then(res => res.json())
...
// Reject Booking AN USER
    ...
    if (proceed) {
        const url = `https://bongo-car-bazar.herokuapp.com/reject-booking/${id}`;
        fetch(url, {
            method: 'PUT'
        })
            .then(res => res.json())
    ...
    const handleDeleteBooking = id => {
        ...
        if (proceed) {
            const url = `https://bongo-car-bazar.herokuapp.com/bookings/${id}`;
            fetch(url, {
                method: 'DELETE'
            })
            .then(res => res.json())
